...
export default function ATMPreview() {
  ...
  const processInput = () => {
    ...
    switch (currentScreen) {
      ...
      case "enter-pin":
        const accountNumber = inputBuffer
        setInputBuffer("")

        if (input.length === 4) {
          const account = accounts.find((acc) => acc.accountNumber === accountNumber && acc.pin === input)
          if (account) {
      ...
      case "enter-pin":
        return (
          <div className="text-center text-white space-y-6">
            ...
            <div className="bg-gray-800 p-4 rounded font-mono text-xl min-h-[60px] flex items-center justify-center">
              {"*".repeat(Math.min(inputBuffer.length, 4))}
            </div>
      ...
      <div className="max-w-7xl mx-auto bg-blue-600 rounded-b-lg shadow-2xl">
        <div className="flex">
          ...
          <div className="w-80 p-6 space-y-6">
            ...
            <Card className="bg-white">
              <CardContent className="p-4">
                <div className="text-center font-bold mb-2 text-sm">Test Accounts</div>
